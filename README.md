...
Esta rama está dedicada exclusivamente al desarrollo de la fase de Exploratory Data Analysis (Análisis Exploratorio de Datos). Puede incluir tanto el notebook principal, como las versiones candidatas, borradores, etc.
...
├── notebooks/                # Desarrollo de notebooks de eda
