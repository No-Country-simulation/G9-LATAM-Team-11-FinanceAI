...
Se entrenaron 2 sistemas de clasificación: perfilado financiero y modelo de categorización de transacciones (NLP)


## MLOps y Validación

Para garantizar la integridad científica de los modelos, este cuaderno **obedece estrictamente** los splits de separación generados en el Notebook 1:
